...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-md bg-black py-1 py-lg-3">
        <div class="container d-flex justify-content-between">
            <a class="navbar-brand">
                <svg width="100" height="50" viewBox="0 0 616 210" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="collapse navbar-collapse d-lg-flex justify-content-end flex-grow-0" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item ms-lg-4">
                        <a class="nav-link btn-login px-5 btn-sm rounded-pill text-center" aria-current="page"
