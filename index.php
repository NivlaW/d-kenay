        ...
        <div class="container d-flex justify-content-between">
            ...
            <button class="navbar-toggler text-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                <svg width="30" height="30" xmlns='http://www.w3.org/2000/svg' fill="none" viewBox='0 0 30 30'>
                    <path stroke='#FF9800' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22' />
                </svg>
            </button>
            <div class="collapse navbar-collapse d-lg-flex justify-content-end flex-grow-0" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item ms-4">
                        <a class="nav-link btn-login px-5 btn-sm rounded-pill" aria-current="page" href="view/login.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container-fluid container-lg">
            <div class="row justify-content-center">
                <div class="row product-strength-1 ">
                    ...
                    <div class="mt-4 mt-lg-0 col-lg-6 gap-lg-4 d-flex justify-content-center flex-column align-items-lg-baseline align-items-center" data-aos="fade-left">
                        ...
                        <div class="d-flex gap-5 my-3 my-lg-0">
                            <div class="d-flex justify-content-center align-content-center flex-column">
                                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="#ff9800" viewBox="0 0 256 256">
        ...
        <div class="container-fluid container-lg position-relative">
            <div class="row justify-content-center">
                <div class="row product-strength-1">
                    ...
                    <div class="mt-4 mt-lg-0 col-lg-6 gap-lg-4 d-flex justify-content-center flex-column kiri order-last order-lg-first align-items-lg-baseline" data-aos="fade-right">
            ...
            <div class="row justify-content-center">
                <div class="row product-strength-1 ">
                    ...
                    <div class="mt-4 mt-lg-0 col-lg-6 gap-lg-4 d-flex justify-content-center flex-column align-items-lg-baseline" data-aos="fade-left">
                        ...
                        <div class="d-flex gap-3 my-4 my-lg-0 flex-wrap justify-content-center justify-content-lg-start">
        ...
        <div class="container-fluid container-lg">
            <div class="row justify-content-center">
                ...
                <div class="d-flex gap-4 my-4 my-lg-4 flex-wrap justify-content-center ">
                    <div class="card rounded-4 justify-content-center align-items-center">
                        <img class="card-img" src="./view/foto/594-BBQ_GRILL.png" alt="">
                        <div class="card-body text-black">
                            <h6 class="card-title">Grill Chiken Steak</h6>
                            <div class="d-flex justify-content-between flex-wrap align-content-center align-items-center">
                                <h6 class="card-subtitle text-muted">Rp. 26.000</h6>
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#ff9800" viewBox="0 0 256 256">
                    ...
                    <div class="card rounded-4 justify-content-center align-items-center">
                        <img class="card-img" src="./view/foto/3717-steak.png" alt="">
                        <div class="card-body text-black">
                            <h6 class="card-title">Crispy Chiken Steak</h6>
                            <div class="d-flex justify-content-between flex-wrap align-content-center align-items-center">
                                <h6 class="card-subtitle text-muted">Rp. 26.000</h6>
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="#ff9800" viewBox="0 0 256 256">
                                    <path d="M234.29,114.85l-45,38.83L203,211.75a16.4,16.4,0,0,1-24.5,17.82L128,198.49,77.47,229.57A16.4,16.4,0,0,1,53,211.75l13.76-58.07-45-38.83A16.46,16.46,0,0,1,31.08,86l59-4.76,22.76-55.08a16.36,16.36,0,0,1,30.27,0l22.75,55.08,59,4.76a16.46,16.46,0,0,1,9.37,28.86Z">
        ...
        <div class="container">
            ...
            <form class="mt-4" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nm_pelanggan" placeholder="Masukkan nama lengkap Anda">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="jml_makanan" placeholder="Masukkan Jumlah Menu Yang Dipesan">
                </div>
                <div class="mb-3">
